...
public class MainActivity extends Activity{
 ...
 private static final String STABILITY="javascript:(function(){try{if(document.getElementById('rihlaAppStabilityV3'))return;var s=document.createElement('script');s.id='rihlaAppStabilityV3';s.src='file:///android_asset/www/app-stability-v3.js';document.body.appendChild(s)}catch(e){console.log('stability',e)}})();";

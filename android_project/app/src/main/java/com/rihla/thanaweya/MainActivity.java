...
public class MainActivity extends Activity{
 WebView web;
 private static final String INJECT="javascript:(function(){try{var a=[['rihlaAIUX','aiux.js'],['rihlaSubscriptionV2','subscription-v2.js'],['rihlaAdminAccess','admin-access-v2.js'],['rihlaCoreV7','app-core-v7.js']];a.forEach(function(x){if(!document.getElementById(x[0])){var s=document.createElement('script');s.id=x[0];s.src='file:///android_asset/www/'+x[1];document.body.appendChild(s)}})}catch(e){console.log('inject',e)}})();";
